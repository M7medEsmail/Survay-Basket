...
namespace SurvayBacket.Api.Presistance.Migrations
{
    ...
    [Migration("20251208192130_AFterApplyingClone")]
    partial class AFterApplyingClone
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurvayBacket.Api.Entities.Vote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SurvayBacket.Api.Entities.VoteAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SurvayBacket.Api.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SurvayBacket.Api.Entities.Vote", b =>
                {
                    ...
                    b.HasOne("SurvayBacket.Api.Entities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SurvayBacket.Api.Entities.VoteAnswer", b =>
                {
                    b.HasOne("SurvayBacket.Api.Entities.Answer", "Answer")
                        .WithMany()
                    ...
                    b.HasOne("SurvayBacket.Api.Entities.Vote", "Vote")
                        .WithMany("VoteAnswers")
